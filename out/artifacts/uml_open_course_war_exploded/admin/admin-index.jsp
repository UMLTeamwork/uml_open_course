...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="../servlet/TeachingArrangementAdminServlet?type=general" data-title="教学大纲" href="javascript:;">教学大纲</a></li>
                    <li><a data-href="../servlet/AdminCalendarServlet?method=showAll" data-title="教学日历" href="javascript:void(0)">教学日历</a></li>
                    <li><a data-href="../servlet/TeachingContentAdminServlet?type=content" data-title="教学内容" href="javascript:;">教学内容</a></li>
                    <li><a data-href="../servlet/TeachingArrangementAdminServlet?type=plan" data-title="授课计划" href="javascript:void(0)">授课计划</a></li>
                    <li><a data-href="../servlet/TeachingHDPointsAdminServlet?type=points" data-title="教学重难点" href="javascript:;">教学重难点</a></li>
                    <li><a data-href="../servlet/TeachingMeasureAdminServlet?type=measure" data-title="教学方法与手段" href="javascript:void(0)">教学方法与手段</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="../servlet/WeChatServlet?type=show" data-title="微信群" href="javascript:void(0)">微信群</a></li>
                    <li><a data-href="../servlet/QQGroupServlet?type=show" data-title="QQ群" href="javascript:void(0)">QQ群</a></li>
                    <li><a data-href="../servlet/TeachingArrangementAdminServlet?type=showLeaveMsg" data-title="网站内的师生互动" href="javascript:void(0)">网站内的师生互动</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
