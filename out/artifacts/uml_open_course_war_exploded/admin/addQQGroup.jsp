...
<article class="page-container" id="form-article-add">
    <form action="/uml_open_course/servlet/QQGroupServlet?type=add" method="post" enctype="multipart/form-data">
        ...
        <p>idkey：<input name="idkey" type="text"><a href="https://qun.qq.com/join.html" title="获取idkey" target="_blank">获取idkey</a></p>
