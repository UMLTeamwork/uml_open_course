...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        <a class="btn btn-primary radius" data-title="添加教学日历" data-href="calendarAdd.jsp" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加教学日历</a>
        </span>
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <c:forEach var="calendar" items="${calendars}">
                <tr class="text-c">
                    ...
                    <td><c:if test="${calendar.used == 0}"><a href="../servlet/AdminCalendarServlet?method=use&cid=${calendar.cid}">使用</a></c:if>
                        <c:if test="${calendar.used == 1}"><a href="../servlet/AdminCalendarServlet?method=stop&cid=${calendar.cid}">停用</a></c:if>
                    <a href="../servlet/AdminCalendarServlet?method=delete&cid=${calendar.cid}">删除</a>
