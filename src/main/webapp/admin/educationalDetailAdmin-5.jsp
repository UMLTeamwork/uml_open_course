...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        <a class="btn btn-primary radius" data-title="添加教学重难点" data-href="teachingHDPointsAdd.jsp" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加教学重难点</a>
        </span>
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <c:forEach var="point" items="${requestScope.points }">
                <tr class="text-c">
                    ...
                    <td><a href="../servlet/TeachingHDPointsAdminServlet?type=usePoint&pointId=${point.pointId}">使用</a> <a href="../servlet/TeachingHDPointsAdminServlet?type=delPoint&pointId=${point.pointId}">删除</a></td>
