        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <c:forEach var="plan" items="${requestScope.plans }">
                <tr class="text-c">
                    ...
                    <td><a href="../servlet/TeachingArrangementAdminServlet?type=usePlan&planId=${plan.planId}">使用</a> <a href="../servlet/TeachingArrangementAdminServlet?type=delPlan&planId=${plan.planId}">删除</a></td>
